...
import { podDeviceApi, type PodDeviceItem } from '../../api/lib/podDeviceApi'
              ...
              {doors.length > 0 ? doors.map((door) => (
                <div key={door.id} className="rounded-xl border border-gray-200 overflow-hidden">
                  ...
                  <div className="p-5 grid grid-cols-2 gap-4">
                    {/* Lock status */}
                    <div className={`flex flex-col items-center gap-3 p-4 rounded-xl border-2 transition-colors ${door.lock_status === 'LOCKED'
                      ...
                      <div className="text-center">
                        ...
                        <span className={`text-sm font-bold ${door.lock_status === 'LOCKED' ? 'text-red-600' : 'text-green-600'
                          }`}>
                          {door.lock_status}
                        </span>
                      </div>
                    ...
                    {/* Sensor status */}
                    <div className={`flex flex-col items-center gap-3 p-4 rounded-xl border-2 transition-colors ${door.door_sensor === 'OPEN'
                      ...
                      <div className="text-center">
                        ...
                        <span className={`text-sm font-bold ${door.door_sensor === 'OPEN' ? 'text-amber-600' : 'text-blue-600'
                          }`}>
                          {door.door_sensor}
                        </span>
                      </div>
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className={`flex-1 flex items-center justify-center gap-2 py-2.5 rounded-lg border-2 text-sm font-medium transition-colors ${doorLockStatus === 'LOCKED'
                      ...
                      <button
                        ...
                        className={`flex-1 flex items-center justify-center gap-2 py-2.5 rounded-lg border-2 text-sm font-medium transition-colors ${doorLockStatus === 'UNLOCKED'
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className={`flex-1 flex items-center justify-center gap-2 py-2.5 rounded-lg border-2 text-sm font-medium transition-colors ${doorSensorStatus === 'CLOSED'
                      ...
                      <button
                        ...
                        className={`flex-1 flex items-center justify-center gap-2 py-2.5 rounded-lg border-2 text-sm font-medium transition-colors ${doorSensorStatus === 'OPEN'
                    ...
                    <tbody>
                      {timeSlots.length === 0 ? (
                        ...
                        <tr key={slot.id} className={`border-t border-gray-100 transition-colors ${selectedSlotIds.includes(slot.id) ? 'bg-blue-50/40' : 'hover:bg-gray-50'}`}>
                          ...
                          <td className="px-3 py-2">
                            <span className={`inline-flex px-2 py-0.5 rounded-full text-xs font-medium ${slot.status === 'AVAILABLE' ? 'bg-green-100 text-green-700' : 'bg-yellow-100 text-yellow-700'
                              }`}>
                              {slot.status}
                            </span>
                          </td>
